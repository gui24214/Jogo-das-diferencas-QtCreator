...
Item {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (tempomin <= 0 && txtcontador.text === "10"){
                stars0_4.visible = false
                stars1_4.visible = true
                stars2_4.visible = false
                stars3_4.visible = false
                timer_tempo.stop()
                txtestrelas.text = estrelas[txtestrelas.text] + 1
            }

            if (tempomin > 0 && tempomin < 2 && temposeg <= 59 && txtcontador.text === "10"){
                stars0_4.visible = false
                stars1_4.visible = false
                stars2_4.visible = true
                stars3_4.visible = false
                timer_tempo.stop()
                txtestrelas.text = estrelas[txtestrelas.text] + 2
            }

            if (tempomin >= 2 && txtcontador.text === "10"){
                stars3_4.visible = true
                stars0_4.visible = false
                stars1_4.visible = false
                stars2_4.visible = false
                timer_tempo.stop()
            ...
            if ( txttempo2.text === "?" && txtcontador.text === "10" ) {
                stars0_4.visible = false
                stars1_4.visible = true
                stars2_4.visible = false
                stars3_4.visible = false
    ...
    Image {
        ...
        width: 1000
        height: 1000
        source:"file:///C:/Users/guilh/Downloads/06-20250808T012321Z-1-001/Backup --30- 06/dif - Copy2-20240528T214048Z-001/dif - Copy2/Imagens/level4.jpg"
        //"https://img.jagranjosh.com/images/2022/October/21102022/spot%20the%20difference%20puzzle.jpg"
        fillMode: Image.PreserveAspectFit
        anchors.centerIn: parent
    }
    ...
    Text {
        id: _Dica1
        text: "DICA: Tem 4 diferenças nas Arvores"
        color:"blue"
        font.pixelSize: 38
        font.bold: true
        font.family: "Courier New"
    ...
    Item {
        anchors.right: imgesquilo.right
        anchors.rightMargin: 0
        anchors.top: imgesquilo.top
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    if (_aa.visible && _bb.visible && _cc.visible && _dd.visible && _ee.visible && _ff.visible && _gg.visible && _hh.visible && _ii.visible && _jj.visible) {
                        _win1.visible = true;
                        winclick.play()
                        level5fake.visible = false
                        level5.visible = true
                    }
                }
            }
 ...
 recomeçar o nivel "
    ...
    Rectangle {
        ...
        Text {
            id: _txtselectlvl5
            text: "Selecione o Butão Menu Principal para jogar o nivel 5"
            font.pixelSize: 30
            font.bold: true
            font.family: "Courier New"
        ...
        Row {
            spacing: 30
            anchors.top: _txtselectlvl5.bottom
            anchors.topMargin: 20
            anchors.horizontalCenter: parent.horizontalCenter
