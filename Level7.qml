...
Item {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (tempomin <= 1 && txtcontador.text === "20"){
                stars0_7.visible = false
                stars1_7.visible = true
                stars2_7.visible = false
                stars3_7.visible = false
                timer_tempo.stop()
            ...
            if (tempomin > 1 && tempomin < 3 && txtcontador.text === "20"){
                stars0_7.visible = false
                stars1_7.visible = false
                stars2_7.visible = true
                stars3_7.visible = false
                timer_tempo.stop()
    ...
    Image {
        ...
        width: 1000
        height: 1000
        source:"file:///C:/Users/guilh/Downloads/06-20250808T012321Z-1-001/Backup --30- 06/dif - Copy2-20240528T214048Z-001/dif - Copy2/Imagens/level7_2.png"
        //"https://img.freepik.com/premium-vector/saint-valentine-day-find-differences-game-children-holiday-educational-activity-with-caterpillars-garden-printable-worksheet-with-cute-characters-puzzle-kids-with-love-theme_150240-1736.jpg?w=1480"
    ...
    Rectangle {
        ...
        color: "white"
        opacity: 1
        anchors.horizontalCenter: imganjo.horizontalCenter
        anchors.top: imganjo.top
        anchors.topMargin: 0
    }
    ...
    Text {
        id: _Dica1
        text: "DICA: Tem 8 diferenças nas lagartas"
        color:"blue"
        font.pixelSize: 37
        font.bold: true
        font.family: "Courier New"
 ...
 recomeçar o nivel "
        ...
        MouseArea {
            ...
            onClicked: {
                ...
                rowcontador.anchors.leftMargin = 565
                erro1.visible = true
    ...
    Rectangle {
        ...
        Text {
            id: _txtselectlvl7
            text: "Selecione o Butão Menu Principal para jogar o nivel 8"
            font.pixelSize: 30
            font.bold: true
            font.family: "Courier New"
        ...
        Row {
            spacing: 30
            anchors.top: _txtselectlvl7.bottom
            anchors.topMargin: 20
            anchors.horizontalCenter: parent.horizontalCenter
