...
Item {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (tempomin <= 1 && txtcontador.text === "31"){
                stars0_9.visible = false
                stars1_9.visible = true
                stars2_9.visible = false
                stars3_9.visible = false
                timer_tempo.stop()
                txtestrelas.text = estrelas[txtestrelas.text] + 1
            }

            if (tempomin > 1 && tempomin < 3 && txtcontador.text === "31"){
                stars0_9.visible = false
                stars1_9.visible = false
                stars2_9.visible = true
                stars3_9.visible = false
                timer_tempo.stop()
                txtestrelas.text = estrelas[txtestrelas.text] + 2
            }

            if (tempomin >= 3 && txtcontador.text === "31"){
                stars3_9.visible = true
                stars0_9.visible = false
                stars1_9.visible = false
                stars2_9.visible = false
                timer_tempo.stop()
            ...
            if ( txttempo2.text === "?" && txtcontador.text === "31" ) {
                stars0_9.visible = false
                stars1_9.visible = true
                stars2_9.visible = false
                stars3_9.visible = false
    ...
    Image {
        ...
        width: 1000
        height: 1000
        source:"file:///C:/Users/guilh/Downloads/06-20250808T012321Z-1-001/Backup --30- 06/dif - Copy2-20240528T214048Z-001/dif - Copy2/Imagens/level9.jpg"
        //"https://cdn1.vectorstock.com/i/1000x1000/38/00/marine-inhabitants-find-30-differences-vector-35863800.jpg"
    ...
    Rectangle {
        ...
        height: 457
        color: "white"
        anchors.horizontalCenter: image10.horizontalCenter
        anchors.bottom: image10.bottom
    ...
    Text {
        id: _Dica1
        text: "DICA: Tem 11 diferencas envolvendo Peixes"
        color:"blue"
        font.pixelSize: 34
        font.bold: true
        font.family: "Courier New"
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    if (_aa.visible && _bb.visible && _cc.visible && _dd.visible && _ee.visible && _ff.visible && _gg.visible && _hh.visible && _ii.visible && _jj.visible && _kk.visible && _ll.visible  && _mm.visible  && _nn.visible  && _oo.visible && _pp.visible && _qq.visible && _rr.visible && _ss.visible && _tt.visible && _uu.visible && _vv.visible && _ww.visible && _xx.visible && _yy.visible && _zz.visible && _XI.visible && _XII.visible && _XIII.visible && _XIV.visible && _XV.visible ) {
                        _win1.visible = true;
                        winclick.play()
 ...
 recomeçar o nivel "
    ...
    Rectangle {
        ...
        Text {
            id: _txtselectlvl10
            text: "Selecione o Butão Menu Principal para jogar o nivel 10"
            font.pixelSize: 30
            font.bold: true
            font.family: "Courier New"
    ...
    Rectangle {
        ...
        Image {
            id: imgparty2
            source:"file:///C:/Users/guilh/Downloads/06-20250808T012321Z-1-001/Backup --30- 06/dif - Copy2-20240528T214048Z-001/dif - Copy2/Imagens/level9_2.jpg"
            //"https://cdn1.vectorstock.com/i/1000x1000/38/00/marine-inhabitants-find-30-differences-vector-35863800.jpg"
            fillMode: Image.PreserveAspectFit
            anchors.fill: parent
        }
