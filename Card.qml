...
Item {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            if (tempomin <= 0 && txtcontador.text === "8"){
                stars0_2.visible = false
                stars1_2.visible = true
                stars2_2.visible = false
                stars3_2.visible = false
                timer_tempo.stop()
                txtestrelas.text = estrelas[txtestrelas.text] + 1
            }

            if (tempomin > 0 && tempomin < 2 && temposeg <= 59 && txtcontador.text === "8"){
                stars0_2.visible = false
                stars1_2.visible = false
                stars2_2.visible = true
                stars3_2.visible = false
                timer_tempo.stop()
                txtestrelas.text = estrelas[txtestrelas.text] + 2
            }

            if (tempomin >= 2 && txtcontador.text === "8"){
                stars3_2.visible = true
                stars0_2.visible = false
                stars1_2.visible = false
                stars2_2.visible = false
                timer_tempo.stop()
            ...
            if ( txttempo2.text === "?" && txtcontador.text === "8" ) {
                stars0_2.visible = false
                stars1_2.visible = true
                stars2_2.visible = false
                stars3_2.visible = false
    ...
    Image {
        id: imgscooby
        source:"file:///C:/Users/guilh/Downloads/06-20250808T012321Z-1-001/Backup --30- 06/dif - Copy2-20240528T214048Z-001/dif - Copy2/Imagens/level2.jpg"
    ...
    Item {
        anchors.right: imgscooby.right
        anchors.rightMargin: 0
        anchors.top: imgscooby.top
        anchors.topMargin: 15
        width: 450
        height: 400
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    if (_aa.visible && _bb.visible && _cc.visible && _dd.visible && _ee.visible && _ff.visible && _gg.visible && _hh.visible) {
                        _win1.visible = true;
                        winclick.play()
                        level3fake.visible = false
                        level3.visible = true
                    }
                }
            }
    ...
    Text {
        id: _Dica2
        text: "DICA: Tem 3 Diferenças na Arma"
        color:"blue"
        font.pixelSize: 40
        font.bold: true
        font.family: "Courier New"
 ...
 recomeçar o nivel "
    ...
    Rectangle {
        ...
        Text {
            id: _txtselectlvl3
            text: "Selecione o Butão Menu Principal para jogar o nivel 3"
            font.pixelSize: 30
            font.bold: true
            font.family: "Courier New"
        ...
        Row {
            spacing: 30
            anchors.top: _txtselectlvl3.bottom
            anchors.topMargin: 20
            anchors.horizontalCenter: parent.horizontalCenter
    ...
    Rectangle {
        ...
        Image {
            id: imgparty2
            width: parent.width //2100
            height:  parent.height//800
            source:"file:///C:/Users/guilh/Downloads/06-20250808T012321Z-1-001/Backup --30- 06/dif - Copy2-20240528T214048Z-001/dif - Copy2/Imagens/level2.jpg"
            //fillMode: Image.PreserveAspectFit
            anchors.fill: parent
            anchors.horizontalCenter: parent.horizontalCenter
